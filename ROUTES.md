...
|-------|--------|-------------|------|
| `/login` | ✅ Used | Login / sign-up page (invite-only) | Public |
| `/auth/callback` | ✅ Used | Supabase OAuth callback | Public |
| `/onboarding` | ✅ Used | Company invite activation | Public |

### Platform Admin
| Route | Status | Description | Auth |
|-------|--------|-------------|------|
| `/platform` | ✅ Used | Platform admin: create & manage invites | Admin only |
