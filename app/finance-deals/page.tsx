...
import { createClientComponentClient } from '@/lib/supabase/client' // Declare the variable before using it
...
export default function FinanceDealsPage() {
  ...
  const supabase = createClientComponentClient() // Use the declared variable
